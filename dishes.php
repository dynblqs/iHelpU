            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="res_category.php">Services <span class="sr-only"></span></a> </li>
    ...
    <div class="page-wrapper">
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="#">Choose Service</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="restaurants.php">Choose Vendor</a></li>
                    <li class="col-xs-12 col-sm-4 link-item active"><span>3</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Order</a></li>
        ...
        <?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
        <section class="inner-page-hero bg-image" data-image-src="images/img/pimg.png">
            <div class="profile">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                            <div class="image-wrap">
                                <figure><?php echo '<img src="admin/Res_img/'.$rows['image'].'" alt="Logo">'; ?></figure>
                            </div>
                        </div>
...
?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <a href="runner.php?res_id=<?php echo $_GET['res_id'];?>&action=check" class="btn btn-danger btn-lg disabled">Checkout</a>

                                <?php
                                        }
                                        else{   
                                        ?>
                                <a href="runner.php?res_id=<?php echo $_GET['res_id'];?>&action=check" class="btn btn-success btn-lg active">Checkout</a>
                                <?php   
                                        }
                                        ?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">
                                ITEM <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
