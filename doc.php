...
<head>
    ...
    <link rel="icon" href="#">
    <title>Printing Kiosk || iHelpU</title>
...
<body>
    ...
    <div class="page-wrapper">
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="#">Choose Vendor</a></li>
        ...
        <div class="inner-page-hero bg-image" data-image-src="images/img/banner_printing.png">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-9">
                        <div class="bg-gray restaurant-entry">
                            <div class="row">
                                <?php $ress= mysqli_query($db,"select * from restaurant where c_id= '3'");
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<a href="dishes.php?res_id='.$rows['rs_id'].'" class="btn btn-purple">View Item</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
