...
<head>
    ...
    #header {
    background: none; /* Replace 'your_color_here' with the color you desire */
}
...
<body>
    ...
    <header id="header" class="header-scroll top-header headrom" height= "1000">
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
							...
							?>
                                        <tr>
                                            ...
                                            <td data-column="Runner"> <?php echo $row['runner']; ?></td>
