    ...
    <div class="site-wrapper">
        ...
        <div class="page-wrapper">
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="services.php">Choose Service</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="restaurants.php">Choose Vendor</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="dishes.php">Order</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>4</span><a href="runner.php">Choose Runner</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>5</span><a href="checkout.php">Pay</a></li>
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-color"><strong> <?php echo "RM ".$item_total+2; ?></strong></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
