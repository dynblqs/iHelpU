...
$mql = "INSERT INTO users(username, f_name, l_name, email, phone, password, address, u_category) VALUES('".$_POST['username']."','".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['password']."','".$_POST['address']."','".$_POST['u_category']."')";
...
<head>
    ...
    <link rel="icon" href="#">
    <title>Registration || iHelpU</title>
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo_iHelpU.png" alt="" width="7%"> </a>
                            ...
                            <div class="widget">
                                <div class="widget-body">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <input type="hidden" name="u_category" value="1">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <p>
                                                    <a href="registration_runner.php" class="btn theme-btn">Register as Runner</a>
                                                </p>
                                            </div>
                                        </div>
                                    </form>
